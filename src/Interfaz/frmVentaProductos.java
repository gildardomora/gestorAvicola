 ...
 * @author GIMORE
 */
public class frmVentaProductos extends javax.swing.JDialog {

    /**
     * Creates new form frmVentaProductos
     */
    public frmVentaProductos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmVentaProductos dialog = new frmVentaProductos(new javax.swing.JFrame(), true);
