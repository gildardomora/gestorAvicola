 ...
 * @author GIMORE
 */
public class DiagGasto extends javax.swing.JDialog {

    /**
     * Creates new form DiagGasto
     */
    public DiagGasto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
private void cargarinformacion(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiagGasto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DiagGasto dialog = new DiagGasto(new javax.swing.JFrame(), true);
