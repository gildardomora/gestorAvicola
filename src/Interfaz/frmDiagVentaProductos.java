...
import Funciones.fVentaProducto;
 ...
 * @author GIMORE
 */
public class frmDiagVentaProductos extends javax.swing.JDialog {

    /**
     * Creates new form frmVentaProductos
     */
    public frmDiagVentaProductos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmDiagVentaProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmDiagVentaProductos dialog = new frmDiagVentaProductos(new javax.swing.JFrame(), true);
