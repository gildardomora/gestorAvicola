 ...
 * @author GIMORE
 */
public class DiagGalpon extends javax.swing.JDialog {
    /**
     * Creates new form DiagGalpon
     */
    public DiagGalpon(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void cargarinformacion() {
        ...
        switch (frmAdminGalpon.accion) {
            ...
            case "editar":
                txtNumGalpon.requestFocus();
                txtNumGalpon.setText(frmAdminGalpon.datostabla[0]);
                comboTipoAve.setSelectedItem(frmAdminGalpon.datostabla[1]);
                try {
                    fecha = formatoFecha.parse((String) frmAdminGalpon.datostabla[2]);
                    jDateFechaApe.setDate(fecha);
                } catch (ParseException ex) {
                    Logger.getLogger(DiagGalpon.class.getName()).log(Level.SEVERE, null, ex);
                }
                txtSaldoAves.setText(frmAdminGalpon.datostabla[3]);
                AtxtDescripcion.setText(frmAdminGalpon.datostabla[4]);
                  comboEstado.setSelectedItem(frmAdminGalpon.datostabla[5]);
                break;
            default:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiagGalpon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DiagGalpon dialog = new DiagGalpon(new javax.swing.JFrame(), true);
