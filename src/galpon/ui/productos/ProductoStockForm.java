 ...
 * @author GIMORE
 */
public class ProductoStockForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form ProductoStockForm
     */
...
//DefaultTableModel modelo; //=(DefaultTableModel) tablaAdminGalpon.getModel(); // parte para obtener el modelo de tabla existente
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductoStockForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductoStockForm().setVisible(true);
            }
        });
    }
