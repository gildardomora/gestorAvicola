 ...
 * @author GIMORE
 */
public class ProduccionDialog extends javax.swing.JDialog {

    /**
     * Creates new form DiagProduccion
     */
    public ProduccionDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarinformacion();
    ...
    void cargarinformacion() {
        // lblNumGalpon.setText(ProduccionForm.datostabla[1]);
        ...
        switch (ProduccionForm.accion) {
            case "nueva":
                // Calendar actual = new GregorianCalendar();//para asignar la fecha actual
                jDateFecha.setCalendar(actual);
                break;
            case "editar":
                comboGalpon.setSelectedItem(ProduccionForm.datostabla[1]);
                comboProducto.setSelectedItem(ProduccionForm.datostabla[2]);
                txtCantidad.setText(ProduccionForm.datostabla[3]);

                try {
                    fecha = formatoFecha.parse((String) ProduccionForm.datostabla[4]);
                } catch (ParseException ex) {
                    Logger.getLogger(ProduccionDialog.class.getName()).log(Level.SEVERE, null, ex);
                }
                jDateFecha.setDate(fecha);
                //  AtxtObservaciones.setText(ProduccionForm.datostabla[5]);
                break;
        }
    }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        switch (ProduccionForm.accion) {
            case "nueva":
                ...
                if (confirmar == 0) {
                    ProductoModel funcP = new ProductoModel();
            ...
            case "editar":
                  datos.setIdGalpon(Integer.parseInt(comboGalpon.getSelectedItem().toString()));
            datos.setIdProduccion(Integer.parseInt(ProduccionForm.datostabla[0]));
 if (func.editar(datos, comboProducto.getSelectedItem().toString())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProduccionDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProduccionDialog dialog = new ProduccionDialog(new javax.swing.JFrame(), true);
