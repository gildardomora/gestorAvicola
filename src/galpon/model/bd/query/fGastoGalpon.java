...
public class fGastoGalpon {
    ...
    public void desconectarse() {
     ...
     public DefaultTableModel mostrar(String buscar) { //para mostrar registros de la tabla galpon
        ...
        sSQL = "select \"gasto\".\"id_gasto\",\"galpon\".\"id_galpon\","
                + "\"cantidad_gasto_galpon\", \"fecha_apertura\", "
                + "\"estado_galpon\",\"total_gasto_galpon\" "
                + "from \"galpon\" inner join \"gasto_galpon\" "
                + "on \"galpon\".\"id_galpon\"=\"gasto_galpon\".\"id_galpon\" "
                + "inner join \"gasto\" "
                + "on \"gasto_galpon\".\"id_gasto\"=\"gasto\".\"id_gasto\"  "
                + " where \"nombre_gasto\" like '%"+buscar+"%'  "
                + "order by \"id_gasto\" ";
        try {
